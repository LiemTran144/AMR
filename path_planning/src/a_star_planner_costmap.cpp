#include <queue>
#include "path_planning/a_star_planner_costmap.hpp"
...
namespace nhatbot_planning
{
    ...
    {
        RCLCPP_INFO(this->get_logger(), "A Star Path Planning Node has started");
        ...
        map_sub_ = create_subscription<nav_msgs::msg::OccupancyGrid>(
            "/global_costmap/costmap", map_qos, std::bind(&AStarPlanner::mapCallback, this, std::placeholders::_1));  ///costmap/costmap
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<nhatbot_planning::AStarPlanner>();
    rclcpp::spin(node);
