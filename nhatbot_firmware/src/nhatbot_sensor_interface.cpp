...
std::vector<hardware_interface::StateInterface> NhatbotSensorInterface::export_state_interfaces()
{
    ...
    state_interfaces.emplace_back(hardware_interface::StateInterface(sensor_name, "battery_voltage", &battery_voltage_)); // &battery_voltage_ là con trỏ đến biến thành viên
