...
namespace nhatbot_interface
{
    ...
    /*  hardware_interface::HW_IF_VELOCITY = "velocity"
        https://control.ros.org/master/doc/api/namespacehardware__interface.html */
        ...
        std::vector<hardware_interface::StateInterface> state_interfaces;
            ...
            for (size_t i = 0; i < info_.joints.size(); i++)
            {
                state_interfaces.emplace_back(hardware_interface::StateInterface(
                    info_.joints[i].name, hardware_interface::HW_IF_POSITION, &position_states_[i]));   // hardware_interface::HW_IF_POSITION = "position"


                state_interfaces.emplace_back(hardware_interface::StateInterface(
                    info_.joints[i].name, hardware_interface::HW_IF_VELOCITY, &velocity_states_[i]));   // hardware_interface::HW_IF_VELOCITY = "velocity"
            }
    ...
    CallbackReturn NhatbotInterface::on_activate(const rclcpp_lifecycle::State &)
    {
        ...
        velocity_commands_.assign(2, 0.0); // 2 wheels
