...
#ifndef ROSBASIC_MSGS__SRV__DETAIL__MULTI__FUNCTIONS_H_
#define ROSBASIC_MSGS__SRV__DETAIL__MULTI__FUNCTIONS_H_
...
/// Create srv/Multi message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosbasic_msgs__srv__Multi_Request__init().
...
/// Destroy srv/Multi message.
/**
 * It calls
 * rosbasic_msgs__srv__Multi_Request__fini()
...
/// Check for srv/Multi message equality.
/**
...
/// Initialize array of srv/Multi messages.
/**
...
/// Finalize array of srv/Multi messages.
/**
 * It calls
 * rosbasic_msgs__srv__Multi_Request__fini()
...
/// Create array of srv/Multi messages.
/**
 * It allocates the memory for the array and calls
 * rosbasic_msgs__srv__Multi_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Multi messages.
/**
 * It calls
 * rosbasic_msgs__srv__Multi_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Multi message array equality.
/**
...
/// Copy an array of srv/Multi messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosbasic_msgs__srv__Multi_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbasic_msgs
...
/**
 * It calls
 * rosbasic_msgs__srv__Multi_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbasic_msgs
...
/**
 * It allocates the memory for the array and calls
 * rosbasic_msgs__srv__Multi_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosbasic_msgs
...
/**
 * It calls
 * rosbasic_msgs__srv__Multi_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROSBASIC_MSGS__SRV__DETAIL__MULTI__FUNCTIONS_H_
