...
#include "rosbasic_msgs/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rosbasic_msgs::srv::AddTwoInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosbasic_msgs::srv::AddTwoInts_Request & ros_message)
{
  // Member: c
  cdr >> ros_message.c;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosbasic_msgs::srv::AddTwoInts_Request;
    is_plain =
      (
      offsetof(DataType, d) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const rosbasic_msgs::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosbasic_msgs::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  return &rosbasic_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbasic_msgs, srv, AddTwoInts_Request)() {
  return &rosbasic_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosbasic_msgs
cdr_serialize(
  const rosbasic_msgs::srv::AddTwoInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosbasic_msgs::srv::AddTwoInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosbasic_msgs::srv::AddTwoInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rosbasic_msgs::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rosbasic_msgs::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rosbasic_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbasic_msgs, srv, AddTwoInts_Response)() {
  return &rosbasic_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &rosbasic_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbasic_msgs, srv, AddTwoInts)() {
  return &rosbasic_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
