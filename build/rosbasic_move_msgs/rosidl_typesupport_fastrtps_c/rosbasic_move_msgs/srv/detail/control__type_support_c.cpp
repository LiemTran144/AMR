...
#include "rosbasic_move_msgs/srv/detail/control__rosidl_typesupport_fastrtps_c.h"
...
#include "rosbasic_move_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Control_Request__ros_msg_type = rosbasic_move_msgs__srv__Control_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: quangduong
  {
    cdr << ros_message->quangduong;
  }

  // Field name: khoangcach
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosbasic_move_msgs
size_t get_serialized_size_rosbasic_move_msgs__srv__Control_Request(
  const void * untyped_ros_message,
...
static uint32_t _Control_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosbasic_move_msgs__srv__Control_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosbasic_move_msgs
size_t max_serialized_size_rosbasic_move_msgs__srv__Control_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosbasic_move_msgs__srv__Control_Request;
    is_plain =
      (
...
static size_t _Control_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosbasic_move_msgs__srv__Control_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbasic_move_msgs, srv, Control_Request)() {
...
#include "rosidl_runtime_c/string.h"  // notification
#include "rosidl_runtime_c/string_functions.h"  // notification

// forward declare type support functions


using _Control_Response__ros_msg_type = rosbasic_move_msgs__srv__Control_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->notification;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: notification
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->notification.data) {
      rosidl_runtime_c__String__init(&ros_message->notification);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->notification,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'notification'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosbasic_move_msgs
size_t get_serialized_size_rosbasic_move_msgs__srv__Control_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Control_Response__ros_msg_type * ros_message = static_cast<const _Control_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rosbasic_move_msgs__srv__Control_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rosbasic_move_msgs
size_t max_serialized_size_rosbasic_move_msgs__srv__Control_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosbasic_move_msgs__srv__Control_Response;
    is_plain =
      (
...
static size_t _Control_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosbasic_move_msgs__srv__Control_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbasic_move_msgs, srv, Control_Response)() {
...
// already included above
// #include "rosbasic_move_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "rosbasic_move_msgs/srv/control.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbasic_move_msgs, srv, Control)() {
