...
class ZLAC8015D_API:
    ...
    # def set_rpm(self, L_rpm, R_rpm):
    #     """✅ Kiểm tra kết nối trước khi gửi lệnh điều khiển RPM"""
    #     if not self.client.connect():  # 🔴 Kiểm tra lại kết nối trước khi gửi
    #         print("❌ Mất kết nối Modbus! Gửi Emergency Stop.")
    #         self.stop_motor_emergency()
    #         return
    ...
    #     except pymodbus.exceptions.ConnectionException as e:
    #         print(f"❌ Lỗi kết nối Modbus khi gửi set_rpm: {str(e)}")
    #         self.stop_motor_emergency()  # 🔴 Gửi lệnh Emergency Stop
    #     except Exception as e:
    #         print(f"❌ Lỗi không xác định khi gửi set_rpm: {str(e)}")
