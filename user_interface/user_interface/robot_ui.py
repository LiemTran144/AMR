...
class RobotUI(QMainWindow):
    def __init__(self):
        ...
        self.curve_setpoint = self.plot_widget.plot(self.setpoint_x, self.setpoint_y,
                                                     pen=pg.mkPen(color=(0,0,255), width=4), name="Reference Path")  #Reference Path
        
        self.replanned_Path = self.plot_widget.plot(self.setpoint_x, self.setpoint_y,
                                                     pen=pg.mkPen(color=(255,255,0), width=4), name="Replanned Path")  #Replanned Path
