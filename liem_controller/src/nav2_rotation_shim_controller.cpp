...
#include "liem_controller/nav2_rotation_shim_controller.hpp"
...
void RotationShimController::activate()
{
  RCLCPP_INFO(
    ...
    "liem_rotation_shim_controller::RotationShimController",
    plugin_name_.c_str());
  ...
  nav2_core::GoalChecker * goal_checker)
{
  ...
  RCLCPP_INFO_THROTTLE(
    logger_, *clock_, 1000,
    "Rotation Shim Controller passing control to primary controller plugin");

  auto cmd_vel_debug = cmd_vel;
  cmd_vel_debug.twist.linear.x = 0.0;
  cmd_vel_debug.twist.linear.z = 0.0;
