...
{
  new (message_memory) rosbasic_move_msgs::srv::Control_Request(_init);
}

void Control_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosbasic_move_msgs::srv::Control_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Control_Request_message_member_array[2] = {
  {
    ...
    offsetof(rosbasic_move_msgs::srv::Control_Request, quangduong),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosbasic_move_msgs::srv::Control_Request, khoangcach),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Control_Request_message_members = {
  "rosbasic_move_msgs::srv",  // message namespace
  "Control_Request",  // message name
  2,  // number of fields
  sizeof(rosbasic_move_msgs::srv::Control_Request),
...
{
  return &::rosbasic_move_msgs::srv::rosidl_typesupport_introspection_cpp::Control_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbasic_move_msgs, srv, Control_Request)() {
  return &::rosbasic_move_msgs::srv::rosidl_typesupport_introspection_cpp::Control_Request_message_type_support_handle;
}
...
void Control_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rosbasic_move_msgs::srv::Control_Response(_init);
}

void Control_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosbasic_move_msgs::srv::Control_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Control_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosbasic_move_msgs::srv::Control_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosbasic_move_msgs::srv::Control_Response, notification),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Control_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(rosbasic_move_msgs::srv::Control_Response),
...
{
  return &::rosbasic_move_msgs::srv::rosidl_typesupport_introspection_cpp::Control_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbasic_move_msgs, srv, Control_Response)() {
  return &::rosbasic_move_msgs::srv::rosidl_typesupport_introspection_cpp::Control_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Control_service_members = {
  "rosbasic_move_msgs::srv",  // service namespace
  "Control",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<rosbasic_move_msgs::srv::Control>()
...
get_service_type_support_handle<rosbasic_move_msgs::srv::Control>()
{
  ...
  auto service_type_support =
    &::rosbasic_move_msgs::srv::rosidl_typesupport_introspection_cpp::Control_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbasic_move_msgs, srv, Control)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rosbasic_move_msgs::srv::Control>();
}
