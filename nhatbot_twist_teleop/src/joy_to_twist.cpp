...
public:
    JoyToTwistNode() : Node("joy_to_twist")
    {
        ...
        this->declare_parameter("deadman_button", 5);
...
private:
    void joy_callback(const sensor_msgs::msg::Joy::SharedPtr joy_msg)
    {
        ...
        // RCLCPP_INFO(this->get_logger(), "✅ joy_to_twist node is running...", joy_msg*);
        // std::cout << "Received Joy message: " << joy_msg<< std::endl;
        ...
        else
        {
            ...
            double angular_value = joy_msg->axes[3]; // Trục quay trái/phải
            // std::cout << "linear_value: " << linear_value  << " ";
            ...
            // std::cout << "linear" << twist_stamped.twist.linear.x  << " ";
            twist_stamped.twist.angular.z = angular_value * angular_scale_;
            // std::cout << "angular" << twist_stamped.twist.angular.z   << " ";
